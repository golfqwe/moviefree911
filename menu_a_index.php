        ...
        <td height="5"></td>
          ...
          <tr>
            <td id="box-menu">
                    ...
                    <td id="rcorners4" bgcolor="<? echo $theme_bgcolor;?>" align="center"><table width="230" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr >
                          <td align="center" style="height:40px;">
                            <h3 style="color: #FFFFFF; font-size: 20px; margin-top: 5px;height: 15px;font-weight: 300;">ประเภทรายการหนัง</h3>
              ...
              ?>
                          <li><a href="//<?=$titler[3];?>/all-tag.php?tag=<?=$tag_cats[0];?>/<?=$cateurl;?>" title="<?=$rcate[1];?>"><?=$tag_cats[1];?>  [<?=$num;?>]</a></li>
                          <?  } ?>
                        </ul>
                    </div></td>
                  </tr>
                ...
                <table width="230" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#000000">
                  <tr>
                    ...
                    <td id="rcorners4" bgcolor="<? echo $theme_bgcolor;?>" align="center"><table width="230" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr >
                          <td align="center" style="height:40px;">
                            <h3 style="color: #FFFFFF; font-size: 20px; margin-top: 5px;height: 15px;font-weight: 300;">รายการหนังล่าสุด</h3>
                           </td>
                        </tr>
                    </table></td>
                  </tr>
                    ...
                    <td align="center" bgcolor="#000000">
                      <table width="230" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr bgcolor="<? echo $theme_bgcolor;?>">
                          <td  id="rcorners4"align="center" style="height:40px;"><h3 style="color: #FFFFFF; font-size: 20px; margin-top: 5px;height: 15px;font-weight: 300;">ติดตามเราได้ที่ Facebook</h3>
