...
<table width="728" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td align="center"><table width="730" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td id="rcorners4" align="center" id="title-movie" style="color: #FFFFFF; font-size: 24px; background-color: <? echo $theme_bgcolor;?>;">ระบบจัดการข้อมูลสมาชิก</td>
                  </tr>
                  <tr>
                      ...
                      <table width="720" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="center"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="150" height="30" align="right" id="font-main" style="">ชื่อที่ใช้เรียก/นามแฝง</td>
                              <td width="10" height="30" align="center" id="font-main" style="">:</td>
                              <td width="440" height="30" align="left" id="font-main"><?=$_SESSION['m_name'];?></td>
                            </tr>
                            <tr>
                              <td width="150" height="30" align="right" id="font-main" style="">อีเมล์</td>
                              <td width="10" height="30" align="center" id="font-main" style="">:</td>
                              <td width="440" height="30" align="left" id="font-main"><?=$_SESSION['m_email'];?></td>
                            </tr>
                            <tr>
                              <td width="150" height="30" align="right" id="font-main" style="">รหัสผ่าน</td>
                              <td width="10" height="30" align="center" id="font-main" style="">:</td>
                              <td width="440" height="30" align="left" id="font-main"><?=$r[0];?></td>
                            </tr>
                            <tr>
                              <td width="150" height="30" align="right">&nbsp;</td>
                              <td width="10" height="30" align="center">&nbsp;</td>
                              <td width="440" height="30" align="left"><a href="edit-personal.php"><img src="../img/bt-edit-data.png" width="98" height="22" border="0" /></a></td>
                            </tr>
                          </table></td>
                        </tr>
                      </table>
