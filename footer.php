...
<div class="row" style="background-color: #<?=$s_color['color_1'];?>;width: 100%;">	
	<center> <br>
...
<table width="780" style="color: #c9c9c9;" align="center" >
<tr>
...
<a href="javascript:void(0)" onclick="document.getElementById('light').style.display='none'"><img src="//<?=$titler[3];?>/img/Actions-window-close-icon.png"alt="ดูหนังออนไลน์"title="ดูหนังออนไลน์" width="25" height="25"> ปิดโฆษณานี้ </a></p>
<!-- ภาพด้านขวา --><a href="<?=$objResult1[4];?>" target="_blank" >
				  <img src="//<?=$titler[3];?>/ads-img/<?=$objResult1[6];?>"alt="โฆษณาดูหนังออนไลน์"title="โฆษณาดูหนังออนไลน์" width="155" class="img-responsive"></a>
</div>
	<? } if($objResult1[9]==1){?>

<div id="light2" class="white_content3" style="display: block;">
<p style="text-align: right;">
<a href="javascript:void(0)" onclick="document.getElementById('light2').style.display='none'">ปิดโฆษณานี้ <img src="//<?=$titler[3];?>/img/Actions-window-close-icon.png" alt="ดูหนังออนไลน์" title="ดูหนังออนไลน์" width="25" height="25"></a></p>
