...
<!--
body {
  <? if($bgr[2]!=""){ ?>background-image: url(https://<?=$titler[3];?>/bg-img/<?=$bgr[2];?>);
  background-repeat: #<?=$bgr[3];?>;<? }else{?>background-color: #<?=$bgr[1];?>;<?} if($bgr[4]==1){ ?>  
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="1200" border="0" align="center" cellpadding="2" cellspacing="0" id="bg-main">
      <tr>
        <td width="10%" align="center" valign="top"><? include "menu_a_index.php"; ?></td>
                  ...
                  <tr>
                    <td align="center" valign="middle"><? 
                        ...
                        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="//download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="728" border="0">
                          ...
                          <embed src="https://<?=$titler[3];?>/ads-img/<?=$rads2[9];?>" width="728" quality="high" pluginspage="//www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"></embed>
                        </object>
                        <? }} ?>
                      </a></td>
                  </tr>
              ...
              <td align="center"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td id="rcorners4" bgcolor="<? echo $theme_bgcolor;?>" align="center">
                            <h3 style="color: #FFFFFF; font-size: 26px; margin-top: 4px;height: 18px;font-weight: 500;">รายการหนังแนะนำ</h3></td>
                        </tr>
                  <tr>
                    <td align="center">
<?	
...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/th_TH/sdk.js#xfbml=1&version=v16.0&appId=2124626527839517&autoLogAppEvents=1" nonce="wSAskovq"></script>
...
<!--https://<//?=$titler[3];?>/post-<//?=$topic_id;?>/<//?=$topic;?>.html-->
                <table width="730" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td id="rcorners4" bgcolor="<? echo $theme_bgcolor;?>" align="center" height="30" style="height:40px;">
                            <h2><center><span style="font-size: 26px; color: #FFFFFF; font-weight: 400;">รายการหนังอัพเดทล่าสุด</span></center></h2>
...
?></td>
                        ...
                        <tr>
                          <td id="rcorners4" bgcolor="<? echo $theme_bgcolor;?>" align="center" height="30"  style="height:40px;"><span style="font-size: 26px; color: #FFFFFF;"><a href="all-movie.php"> คลิกดูรายการหนังทั้งหมด </a></span></td>
                        </tr>
...
<? } ?>
        ...
        <td width="10%" align="center" valign="top"><? include "menu_index.php"; ?></td>
      </tr>
        <tr width="10%">
    <td height="60" align="center" id="footer"><? include "footer_index.php"; ?></td>
  </tr>
