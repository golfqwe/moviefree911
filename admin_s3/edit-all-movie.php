...
<tr>
              <td align="center" id="font-main"><form method="post" action="p-edit-all-movie.php" enctype="multipart/form-data" name="checkForm" id="checkForm" onsubmit="return check1()">
          ...
          ?>
                  ...
                  <tr>
                    ...
                    <select name="tag" id="tag" style="width:200px;" required>
                      <option value="" style="font-size: 14px;">-- เลือกประเภทหนัง --</option>
                    <?
          ...
          ?>
                      <option  style="font-size: 14px;" value="<?=$rs[0];?>" <? if($rs[0]==$rpost[15]){ ?>selected="selected"<? } ?>><?=$rs[1];?></option>
                    <? } ?>
                    </select></td>
                  </tr>
...
-->
                  ...
                  <tr>
					...
					<? if($rpost[6]!=""){ ?>
					<img src="../post-img/<?=$rpost[6];?>" width="50" height="75" /> <a href="del-all-file.php?id=<?=$id;?>&type=1&filedel=<?=$rpost[6];?>" onclick="javascript:if(!confirm('ท่านต้องการลบข้อมูลจริงหรือไม่')){return false;}">ลบภาพประกอบ</a>
...
<!--
                  <tr>
					...
					<? if($rpost[8]!=""){ ?>
					<a href="del-all-file.php?id=<?=$id;?>&type=2&filedel=<?=$rpost[8];?>" onclick="javascript:if(!confirm('ท่านต้องการลบข้อมูลจริงหรือไม่')){return false;}">ลบไฟล์ VDO</a>
