    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" style=" font-size:16px; font-weight:bold; color:#333333;">จัดการข้อมูลบัญชีธนาคาร</td>
            </tr>
            <tr>
              <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td><font size="3" color="#333333">:: เพิ่มรายการบัญชีธนาคาร :: </font></td>
                </tr>
                <tr>
                  <td><form action="p-add-account.php" method="post" enctype="multipart/form-data" name ="checkForm" id="checkForm" onsubmit="return check1()">
                      <table width="680" border="0" align="center" cellpadding="1" cellspacing="1">
                        <tr bgcolor="#FFFFFF">
                          ...
                          <td align="left"><font size="3">
                            <input name="accname" type="text" id="accname" size="40" />
                          </font></td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                          ...
                          <td width="558" align="left"><font size="3">
                            <input name="accno" type="text" id="accno" size="40" />
                          </font></td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                          <td><div align="right"><font size="3">ธนาคาร 
                            :</font></div></td>
                          <td align="left"><font size="3">
                            <input name="bankname" type="text" id="bankname" size="40" />
                          </font></td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                          <td><div align="right"><font size="3">สาขา :</font></div></td>
                          <td align="left"><font size="3">
                            <input name="branch" type="text" id="branch" size="40" />
                        ...
                        <tr bgcolor="#FFFFFF">
                          <td valign="top"><div align="right"><font size="3">ประเภทบัญชี 
                            :</font></div></td>
                          <td align="left"><font size="3">
                            <input name="acctype" type="text" id="acctype" size="40" />
                          </font></td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                  ...
                  <tr>
                    <td><table width="100%" height="10" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center"><font size="3" color="#000000">รายการบัญชีธนาคาร
