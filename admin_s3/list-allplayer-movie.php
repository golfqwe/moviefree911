                    ...
                    <td align="center"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <table width="750" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                        <tr>
                          ...
                          <td width="100" height="25" align="center" bgcolor="#E9E9E6" style=" font-size:15px; font-weight:bold;">หมวดหมู่</td>
                          <td width="100" height="25" align="center" bgcolor="#E9E9E6" style=" font-size:15px; font-weight:bold;">API</td>
...
$q="SELECT id, cate_id, title, post_date, view, sticky, movie, link_allplayer, link_m3u8 FROM `post` WHERE m_id='$_SESSION[m_id]' AND link_allplayer<>''  and google_drive <> 'series' ";
$q.=" ORDER BY id DESC ";
...
?>
                        <tr><!-- <div class="movie-corner movie-<?=$objResult[6];?>"><?=$objResult[6];?></div> -->
                          ...
                          <td width="100" height="25" align="center" bgcolor="#FFFFFF" style=" font-size:14px;"><a href="../cate-<?=$objResult[1];?>/<?=$urlcate;?>" target="_blank"><?=$rcate[0];?></a>
                         
                          </td>

                          <td width="100" height="25" align="center" bgcolor="#FFFFFF" style=" font-size:12px;">
                            <? if($objResult[7]!=""){ ?>
                               <span class="w3-tag"style="background-color: #ed6deb;"><?=$objResult[7];?></span> 
                            <? } ?>
                            </td>
