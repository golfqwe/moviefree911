    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" style=" font-size:16px; font-weight:bold; color:#333333;"><a href="ads-a4.php">จัดการข้อมูลพื้นที่โฆษณาตำแหน่ง A6</a> <img src="images/arrow.gif" width="7" height="11" /> แก้ไขข้อมูล พื้นที่โฆษณาตำแหน่ง A6</td>
            </tr>
            <tr>
              <td align="center"><form id="form1" name="form1" method="post" action="p-ads-a6.php" enctype="multipart/form-data">


                <table width="95%" border="0" align="center" cellpadding="3" cellspacing="3">
                  <tr>
                    <td  width="20%"align="center">
						<img src="../ads-img/<?=$r[6];?>" width="450" border="0" />
					</td>
                  </tr>
                </table>
                <table width="660" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="500" align="left">
						<label><input type="radio"  name="show" id="show" value="1" <?php  if($r[9]==1){ echo "checked";}?> >แสดง</label>
						<label><input type="radio"  name="show" id="show" value="0" <?php if($r[9]==0){ echo 'checked';}?>>ไม่แสดง</label>					
