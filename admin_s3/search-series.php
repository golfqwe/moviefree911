    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" id="font-main" style="font-weight:bold; color:#333333;">ค้นหาซีรี่ย์</td>
            </tr>
            <tr>
              <td align="center"><form id="form1" name="form1" method="post" action="">
                <table width="480" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="428"><input type="text" name="keys" onblur="if(this.value==''){this.value='ค้นหาซีรี่ย์ที่ต้องการได้ที่นี่';}" onclick="if(this.value=='ค้นหาซีรี่ย์ที่ต้องการได้ที่นี่'){this.value='';}" value="ค้นหาซีรี่ย์ที่ต้องการได้ที่นี่" style="width:428px; color:#999999;"/></td>
                    <td width="10">&nbsp;</td>
...
$q="SELECT id, cate_id, title, post_date, view, sticky, movie FROM `post` WHERE title LIKE '%$keys%' AND google_drive = 'series'  ";
$q.=" ORDER BY id DESC ";
...
?>
                          <tr>
                            ...
                            <td width="300" height="25" align="left" bgcolor="#FFFFFF" style=" font-size:16px;">&nbsp;&nbsp;
                                <? if($objResult[5]==1){ ?>
                              <span style="font-weight:bold; color:#FF0000;">[ ซีรี่ย์แนะนำ ]</span>
                                <? } ?>
                              <a href="../post-<?=$objResult[0];?>/<?=$posturl;?>.html" target="_blank">
                                <?=$objResult[2];?>
                              </a><div class="movie-<?=$objResult[11];?>"><?=$objResult[6];?></div></td>
                            <td width="200" height="25" align="center" bgcolor="#FFFFFF" style=" font-size:16px;"><a href="../cate-<?=$objResult[1];?>/<?=$urlcate;?>" target="_blank">
                              <?=$rcate[0];?>
                            </a></td>
                            ...
                            <td width="50" height="25" align="center" bgcolor="#FFFFFF"><a href="edit-series.php?id=<?=$objResult[0];?>"><img src="images/edit.gif" width="40" height="15" border="0" /></a></td>
                  ...
                  <tr>
                    <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="center"><font size="3" color="#000000">ผลการค้นหาซีรี่ย์ทั้งหมด
                         <?=$total;?>
                          รายการ : แสดงผลหน้าละ
                          <?=$e_page;?>
                          รายการ จำนวนทั้งหมด
