    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" style=" font-size:16px; font-weight:bold; color:#333333;">จัดการข้อมูลวิธีการสมัครสมาชิกวีไอพี</td>
            </tr>
            <tr>
              <td><form id="form1" name="form1" method="post" action="p-how-to-vip.php">
                <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left">
                      <textarea class="cleditorMain" id="editor" name="input" style="width:720px; height:450px;"><?=stripslashes($r[1]);?></textarea></td>
                  </tr>
                  <tr>
