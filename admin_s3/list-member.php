    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" id="font-main" style="font-weight:bold; color:#333333;">จัดการข้อมูลสมาชิกทั่วไป</td>
            </tr>
            <tr>
              <td><table width="750" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#E9E9E6">
                <tr>
                  ...
                  <td width="175" height="30" align="center" valign="middle" bgcolor="#EFEFED" id="font-main" style="font-weight:bold;">ชื่อที่ใช้เรียก/นามแฝง</td>
                  <td width="150" height="30" align="center" valign="middle" bgcolor="#EFEFED" id="font-main" style="font-weight:bold;">User / อีเมล์</td>
                  <td width="75" height="30" align="center" valign="middle" bgcolor="#EFEFED" id="font-main" style="font-weight:bold;">รหัสผ่าน</td>
                  <td width="150" height="30" align="center" valign="middle" bgcolor="#EFEFED" id="font-main" style="font-weight:bold;">วันที่สมัครสมาชิก</td>
                  <td width="150" height="30" align="center" valign="middle" bgcolor="#EFEFED" id="font-main" style="font-weight:bold;">การกระทำ</td>
                </tr>
...
$q="SELECT id, name, email, pass, reg_date, ip FROM `member` WHERE type=3";
$q.=" ORDER BY id DESC ";
...
?>
                <tr>
                  <td width="50" height="25" align="center" valign="middle" id="font-main"><?=$objResult[0];?></td>
                  <td width="175" height="25" align="center" valign="middle" id="font-main"><?=$objResult[1];?><br><font style="color: red; font-size: 13px;">IP : <?=$objResult[5];?></font></td>
                  <td width="150" height="25" align="center" valign="middle" id="font-main"><?=$objResult[2];?></td>
                  <td width="75" height="25" align="center" valign="middle" id="font-main"><?=$objResult[3];?></td>
                  <td width="150" height="25" align="center" valign="middle" id="font-main"><?=DateThai($objResult[4]);?></td>
                  <td width="150" height="25" align="center" valign="middle"><select name="manage" id="manage" onchange="window.open(this.options[this.selectedIndex].value,'_self')">
                      <option value="" selected="selected">- เลือก -</option>
                      <option value="member-change-vip.php?id=<?=$objResult[0];?>">ปรับระดับเป็นสมาชิกวีไอพี</option>
                      <option value="list-member-refill.php?id=<?=$objResult[0];?>">ประวัติการเติมเงิน</option>
                      <option value="del-member.php?id=<?=$objResult[0];?>&type=3">ลบข้อมูล</option>
                    </select>                  </td>
                </tr>
                <? } ?>
              </table>
                ...
                <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="center" id="font-main">รายการข้อมูลสมาชิกทั่วไป
                         <?=$total;?>
                          รายการ : แสดงผลหน้าละ
                          <?=$e_page;?>
                          รายการ จำนวนทั้งหมด
