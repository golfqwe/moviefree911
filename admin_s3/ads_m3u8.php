...
<title>Admin Panel : ระบบจัดการข้อมูลเว็บไซต์ : โฆษณาก่อนเล่นหนัง .m3u8</title>
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="5" cellspacing="0">
            <tr style="font-weight:bold;">
              <td height="25" align="left" id="font-main" style="font-size: 17px; color:#333333;"><a href="ads_m3u8.php"> หน้าหลัก </a>>> โฆษณาก่อนเล่นหนัง :: <a href="ads_m3u8.php?edit_vide">คลิปโฆษณา</a> || <a href="ads_m3u8.php?edit_link">ลิ้งโฆษณา</a> <a href="img/ads_m3u8.jpg" style="color: red;" target="bank" >คำแนะนำ </a></td>
            </tr>
...
if(isset($_GET['update'])){
  ...
  $insert_link1="update ads_m3u8 set  `name`='".$_FILES['filevdo1']['name']."',`type`='".$_FILES['filevdo1']['type']."' where  posit='link1' ";
  mysqli_query($con_db, $insert_link1);
  }
  if ($_FILES["filevdo2"]["name"] != ""){
    @copy($_FILES["filevdo2"]["tmp_name"],"../vdo/".$_FILES['filevdo2']['name']);  
  $insert_link2="update ads_m3u8 set  `name`='".$_FILES['filevdo2']['name']."',`type`='".$_FILES['filevdo2']['type']."' where  posit='link2' ";  
  mysqli_query($con_db, $insert_link2);
  }
  if ($_FILES["filevdo3"]["name"] != ""){
    @copy($_FILES["filevdo3"]["tmp_name"],"../vdo/".$_FILES['filevdo3']['name']);    
  $insert_link3="update ads_m3u8 set  `name`='".$_FILES['filevdo3']['name']."',`type`='".$_FILES['filevdo3']['type']."' where  posit='link3' ";
  mysqli_query($con_db, $insert_link3);
  }
  if ($_FILES["filevdo4"]["name"] != ""){
    @copy($_FILES["filevdo4"]["tmp_name"],"../vdo/".$_FILES['filevdo4']['name']);  
  $insert_link4="update ads_m3u8 set  `name`='".$_FILES['filevdo4']['name']."',`type`='".$_FILES['filevdo4']['type']."' where  posit='link4' ";
  mysqli_query($con_db, $insert_link4);
  }

print "<meta http-equiv=refresh content=0;URL=ads_m3u8.php>";

} elseif(isset($_GET['del_video'])){

	@unlink ("../vdo/".$_GET["vdo"]);
	$del_post="update ads_m3u8 set `name`='',`type`='' where posit='".$_GET["posit"]."' ";
...
print "<meta http-equiv=refresh content=0;URL=ads_m3u8.php>";
  ...
  $insert_text1="update ads_m3u8 set  `name`='".$_POST['link1']."' where  posit='text_link1' ";
  mysqli_query($con_db, $insert_text1);
  $insert_text2="update ads_m3u8 set  `name`='".$_POST['link2']."' where  posit='text_link2' ";
  mysqli_query($con_db, $insert_text2);
  $insert_text3="update ads_m3u8 set  `name`='".$_POST['link3']."' where  posit='text_link3' ";
  mysqli_query($con_db, $insert_text3);
  $insert_text4="update ads_m3u8 set  `name`='".$_POST['link4']."' where  posit='text_link4' ";
...
?>
          ...
          <tr>
            <td align="center" id="font-main">
              <form method="post" action="ads_m3u8.php?update" enctype="multipart/form-data">
...
?>
          ...
          <tr>
            <td align="center" id="font-main">
              <form method="post" action="ads_m3u8.php?update_link" enctype="multipart/form-data">
                <table width="750" border="0" align="center" cellpadding="5" cellspacing="0">
                  <tr>
                    <td width="140" height="25" align="right" style="font-weight:bold;">แก้ไขเวลา</td>
                    <td width="10" height="25" align="center" style="font-weight:bold;">:</td>
...
?>
          ...
          <tr>
            <td>
              <hr>
              <a href="ads_m3u8.php?edit_vide" style="font-size: 18px;font-weight:bold;">แก้ไขคลิปโฆษณา</a>
              <table width="750" border="0" align="center" cellpadding="5" cellspacing="0">
                  <tr>
                    <td align="right" style="font-weight:bold;">คลิปโฆษณา ตั้งชื่อ ads1</td>
                    <td width="5%" align="center" style="font-weight:bold;">:</td>
                    <td width="80%"><? if($link1){ echo 'https://'.$titler[3].'/vdo/'.$link1;?> [ <a href="ads_m3u8.php?del_video&posit=link1&vdo=<? echo $link1;?>">ลบ</a> ] <?}?></td>
                  </tr>

              </table>
              <hr>
              <a href="ads_m3u8.php?edit_link" style="font-size: 18px;font-weight:bold;">แก้ไขลิ้งโฆษณา</a>
              <table width="750" border="0" align="center" cellpadding="5" cellspacing="0">
                  <tr>
                    <td  align="right" style="font-weight:bold;">ลิงค์โฆษณา</td>
                    <td width="5%" align="center" style="font-weight:bold;">:</td>
              ...
              <hr>
              <a href="ads_m3u8.php?edit_link" style="font-size: 18px;font-weight:bold;">แก้ไขเวลาปิดโฆษณา</a>
              <table width="750" border="0" align="center" cellpadding="5" cellspacing="0">
                  <tr>
                    <td align="right" style="font-weight:bold;">เวลาปิดโฆษณา</td>
