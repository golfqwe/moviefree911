...
$id=$_GET['id'];
//del category
$sql2="delete from category where id='$id'"or die("ERROR $sql2");
mysqli_query($con_db, $sql2);
//select img, vdo
$sp="SELECT img, file_vdo FROM post WHERE cate_id='$id' ";
...
//del post
$del_post="delete from post where cate_id='$id' " or die ("ERROR $del post");
