    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" style=" font-size:16px; font-weight:bold; color:#333333;"><a href="ads-a1.php">จัดการข้อมูลพื้นที่โฆษณาตำแหน่ง A1 Banner Slide ขนาด 1250x356 px</a> <img src="images/arrow.gif" width="7" height="11" /> เพิ่มข้อมูล พื้นที่โฆษณาตำแหน่ง A1</td>
            </tr>
            <tr>
              <td align="center"><form id="form1" name="form1" method="post" action="p-add-ads-a1.php" enctype="multipart/form-data">
