    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" style=" font-size:16px; font-weight:bold; color:#333333;">จัดการข้อมูลประเภทหนัง <img src="images/arrow.gif" width="7" height="11" /> เพิ่มข้อมูลประเภทหนัง</td>
            </tr>
            <tr>
              <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="30"><font size="3" color="#333333">:: เพิ่มข้อมูลประเภทหนัง :: </font></td>
                </tr>
                <tr>
                  <td><table width="580" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td><form method="post" action="p-tagcategory.php" enctype="multipart/form-data" name ="checkForm" id="checkForm" onsubmit="return check1()">
                            <table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="30%" align="right"><font size="3" color="#333333">ชื่อประเภทหนัง</font></td>
                                <td width="10%">&nbsp;</td>
                                <td width="60%" align="left"><input name="name" type="text" id="name" /></td>
                              </tr>
                              <tr>
                                <td align="right" valign="top"><font color="#000000" size="3">Title</font></td>
                                <td>&nbsp;</td>
                                <td align="left"><textarea name="title" cols="50" rows="3" id="title"></textarea></td>
                              </tr>
                              <tr>
                                <td align="right" valign="top"><font color="#000000" size="3">Description</font></td>
                                <td>&nbsp;</td>
                                <td align="left"><textarea name="description" cols="50" rows="3" id="description"></textarea></td>
                              </tr>
                              <tr>
                                <td align="right" valign="top"><font color="#000000" size="3">Keyword</font></td>
                                <td>&nbsp;</td>
                                <td align="left"><textarea name="keyword" cols="50" rows="3" id="keyword"></textarea></td>
                              </tr>
                              <tr>
                                <td align="right">&nbsp;</td>
                                <td>&nbsp;</td>
                                <td align="left"><input type="submit" name="Submit" value="บักทึกข้อมูล" /></td>
                              </tr>
                            </table>
                ...
                <tr>
                  <td><table width="600" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#E9E9E6">
                      <tr>
                        ...
                        <td width="350" height="25" align="center" valign="middle" bgcolor="#EFEFED"><font size="3" color="#333333">ชื่อประเภทหนัง</font></td>
...
$q="SELECT id, tag_name FROM tag_category ";
$q.=" ORDER BY id DESC ";
...
?>
                ...
                <tr>
                  ...
                  <tr>
                    <td align="center"><font size="3" color="#000000">รายการประเภทหนัง
                         <?=$total;?>
                          รายการ : แสดงผลหน้าละ
                          <?=$e_page;?>
                          รายการ จำนวนทั้งหมด
