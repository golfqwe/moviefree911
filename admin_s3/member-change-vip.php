...
$id=$_GET['id'];
$sp="SELECT type, name, email FROM `member` WHERE id='$id'";
    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" id="font-main" style="font-weight:bold; color:#333333;"><a href="list-member.php">จัดการข้อมูลสมาชิกทั่วไป</a> <img src="images/arrow.gif" width="7" height="11" /> ปรับระดับสมาชิกทั่วไป เป็น สมาชิกวีไอพี</td>
            </tr>
            <tr>
              <td><form action="p-member-change-vip.php" method="post" enctype="multipart/form-data" name ="checkForm" id="checkForm" onsubmit="return check1()">
