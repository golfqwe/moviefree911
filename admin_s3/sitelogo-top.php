...
$logo="select * from site_top where id=1";
    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" style=" font-size:16px; font-weight:bold; color:#333333;">จัดการข้อมูล SITE TOP</td>
            </tr>
            <tr>
              <td><form id="form1" name="form1" method="post" action="p-site-logo-top.php" enctype="multipart/form-data">
                <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="center"><font size="3" color="#333333">Site top ควรมีขนาด 650x60 px</font></td>
                  </tr>
                  <tr>
                    <td align="center"><img src="../logo-img/<?=$rlogo[1];?>" width="650" height="60" /></td>
                  </tr>
                  <tr>
