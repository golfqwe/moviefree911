    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" id="font-main" style="color:#333333;">รายการบล็อก <a href="add-blog.php"><span class="w3-tag w3-red">เพิ่มรีวิวหนังใหม่ !</span></a></td>
            </tr>
            <tr>
              <td align="center"><form action="del-admin-blog.php" method="post" name="frmMain" id="frmMain" onsubmit="return onDelete();">
...
$q="SELECT id, title, post_date, view FROM `blog` WHERE m_id='$_SESSION[m_id]'";
$q.=" ORDER BY id DESC ";
...
?>
                        <tr><!-- <div class="blog-corner blog-<?=$objResult[6];?>"><?=$objResult[6];?></div> -->
                          <td width="20" height="25" align="center" bgcolor="#FFFFFF" style=" font-size:15px;"><?=$objResult[0];?></td>

                          <td width="300" height="25" align="left" bgcolor="#FFFFFF" style=" font-size:15px;">&nbsp;&nbsp;<a href="../view-<?=$objResult[0];?>/<?=$posturl;?>.html" target="_blank"><?=$objResult[1];?></a>  </td>
                          <td width="100" height="25" align="center" bgcolor="#FFFFFF" style=" font-size:15px;"><?=DateThai($objResult[3]);?>

                          </td>
                          <td width="60" height="25" align="center" bgcolor="#FFFFFF" style=" font-size:15px;"><?=$objResult[3];?></td>
                          <td width="50" height="25" align="center" bgcolor="#FFFFFF"><a href="edit-blog.php?id=<?=$objResult[0];?>"><img src="images/edit.gif" width="40" height="15" border="0" /></a></td>
