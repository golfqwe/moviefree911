    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td align="center"><form id="form1" name="form1" method="post" action="p-add-ads-a5.php" enctype="multipart/form-data">
                ...
                <table width="660" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="500" align="left">
						<label><input type="radio" name="show" id="show" value="1" checked>แสดงซ้าย</label>
						<label><input type="radio" name="show" id="show" value="0" >แสดงขวา</label>						
                    </td>
                  </tr>
                  <tr>
