    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" id="font-main" style="font-weight:bold; color:#333333;">ค้นหาข้อมูลสมาชิก</td>
            </tr>
            <tr>
              <td><form id="form1" name="form1" method="post" action="">
                <table width="730" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="200" align="left"><select name="type" id="type" style="width:190px; height:30px;">
                        <option value="2"selected="selected">ชื่อที่ใช้เรียก/นามแฝง</option>
                        <option value="1" >รหัสสมาชิก</option>
                        
                        <option value="3">Email</option>
                      </select>
                    </td>
                    <td width="460" align="left"><input name="keys" type="text" id="keys" value="" style="width:450px; height:30px;" /></td>
                    <td width="70" align="left"><input name="Submit" type="submit" id="Submit" value="Search" /></td>
                  </tr>
                </table>
              </form></td>
            </tr>
            ...
            <tr>
              ...
              <table width="750" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#E9E9E6">
                <tr>
                  ...
                  <td width="150" height="30" align="center" valign="middle" bgcolor="#EFEFED" id="font-main" style="font-weight:bold;">ข้อมูลสมาชิก</td>
...
$q="SELECT id, type, name, email, pass,reg_date, exp_date FROM `member` $where AND type>2 ";
$q.=" ORDER BY id DESC ";
...
?>
                <tr>
                  ...
                  <td width="150" height="60" align="center" valign="middle" id="font-main"><table width="140" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="25" align="left">ประเภท : <? if($objResult[1]==3){ echo "สมาชิกทั่วไป"; }else if($objResult[1]==4){ echo "สมาชิกวีไอพี"; } ?></td>
                      </tr>
                      <tr>
                        <td height="25" align="left">ชื่อ : <?=$objResult[2];?></td>
                      </tr>
                    </table></td>
                  <td width="150" height="60" align="center" valign="middle" id="font-main"><table width="165" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="25" align="left">Email : <?=$objResult[3];?></td>
                      </tr>
                      <tr>
                        <td height="25" align="left">รหัสผ่าน : <?=$objResult[4];?></td>
                      </tr>
                  </table></td>
                  <td width="125" height="60" align="center" valign="middle" id="font-main"><?=DateThai($objResult[5]);?></td>
                  <td width="100" height="60" align="center" valign="middle" id="font-main" style="color:#FF0000;"><? if($objResult[1]==3){ echo "ไม่มีวันหมดอายุ"; }else if($objResult[1]==4){ echo DateThai($objResult[6]); } ?></td>
                  <td width="175" height="60" align="center" valign="middle"><select name="manage" id="manage" onchange="window.open(this.options[this.selectedIndex].value,'_self')">
                      ...
                      <option value="del-member.php?id=<?=$objResult[0];?>&amp;type=5">ลบข้อมูล</option>
                    </select>
                  </td>
                </tr>
                <? } ?>
