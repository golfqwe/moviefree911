    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" style=" font-size:16px; font-weight:bold; color:#333333;">จัดการข้อมูลพื้นที่โฆษณาตำแหน่ง A2 ขนาด 728 px :: [ <a href="add-ads-a7.php">เพิ่มตำแหน่งโฆษณา ADS A2</a> ] ::</td>
            </tr>
            <tr>
              <td align="center"><?
                    ...
                    <tr>
                      <td align="center" valign="top"><? if($objResult1[1]==1){?>
                          <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              <td align="left"><font size="3"><a href="edit-ads-a7.php?id=<?=$objResult1[0];?>"><img src="images/edit.gif" width="40" height="15" border="0" /></a> <a href="del-ads7.php?id=<?=$objResult1[0];?>" onclick="javascript:if(!confirm('ท่านต้องการลบข้อมูลจริงหรือไม่')){return false;}"> <img src="images/del.gif" width="40" height="15" border="0" /></a></font></td>
                            </tr>
                          </table>
                        <? }else if($objResult1[1]==2){ ?>
                          <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
