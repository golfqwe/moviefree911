    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" id="font-main" style="font-weight:bold; color:#333333;">จัดการข้อมูลตั้งค่าการเติมเงิน</td>
            </tr>
            <tr>
              <td align="center"><table width="350" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#E9E9E6">
                <tr>
...
?>
                <tr>
                  ...
                  <td width="100" height="25" align="center" valign="middle" id="font-main"><?=$r[2];?> <? if($r[3]==1){ echo "วัน"; }else if($r[3]==2){ echo "เดือน"; }else if($r[3]==3){ echo "ปี"; } ?></td>
