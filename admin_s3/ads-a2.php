    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" style=" font-size:16px; font-weight:bold; color:#333333;">จัดการข้อมูลพื้นที่โฆษณาตำแหน่ง A2 ขนาด 728 px :: [ <a href="add-ads-a2.php">เพิ่มตำแหน่งโฆษณา ADS A2</a> ] ::</td>
            </tr>
            <tr>
              <td align="center"><?
					$strSQL1="SELECT * FROM ads_a2 ORDER BY id ASC";
                    ...
                    <tr>
                      <td align="center" valign="top"><? 
						  ...
						  echo $ads; 
						  	...
						  	if($objResult1[2]==1){
						  ?>
                          <img src="../ads-img/<?=$objResult1[9];?>" width="728" border="0" />
                          ...
                          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="728">
                            ...
                            <embed src="../ads-img/<?=$objResult1[9];?>" width="728" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"></embed>
                          </object>
                      <? }} ?></td>
                    </tr>
                    <tr>
                          ...
                          <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              <td align="left"><? $ads=stripslashes($objResult1[3]); ?>
                                  <textarea name="textarea" rows="10" style="width:600px;" disabled="disabled"><?=$ads;?></textarea>
                              </td>
                            </tr>
                            <tr>
                              <td align="left"><font size="3"><a href="edit-ads-a2.php?id=<?=$objResult1[0];?>"><img src="images/edit.gif" width="40" height="15" border="0" /></a> <a href="del-ads2.php?id=<?=$objResult1[0];?>" onclick="javascript:if(!confirm('ท่านต้องการลบข้อมูลจริงหรือไม่')){return false;}"> <img src="images/del.gif" width="40" height="15" border="0" /></a></font></td>
                            </tr>
                          </table>
                        <? }else if($objResult1[1]==2){ ?>
                          <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
