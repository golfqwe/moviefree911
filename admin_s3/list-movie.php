    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" id="font-main" style="color:#333333;">รายการหนังทั้งหมด <a href="add-movie.php"><span class="w3-tag w3-red">เพิ่มหนังใหม่ !</span></a></td>
            </tr>
            <tr>
              <td align="center"><form action="del-all-movie.php" method="post" name="frmMain" id="frmMain" onsubmit="return onDelete();">
                  ...
                  <tr>
                    <td align="center"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <table width="750" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                        <tr>
                          <td width="20" height="25" align="center" bgcolor="#E9E9E6" style=" font-size:14px; ">#</td>
                          <td width="300" height="25" align="center" bgcolor="#E9E9E6" style=" font-size:14px; ">ชื่อเรื่อง</td>
                          <td width="200" height="25" align="center" bgcolor="#E9E9E6" style=" font-size:14px; ">หมวดหมู่</td>
                          <td width="100" height="25" align="center" bgcolor="#E9E9E6" style=" font-size:14px; ">วันที่โพสต์</td>
                          <td width="60" height="25" align="center" bgcolor="#E9E9E6" style=" font-size:14px; ">เข้าชม</td>
                          <td width="50" height="25" align="center" bgcolor="#E9E9E6" style=" font-size:14px; ">แก้ไข</td>
...
?>
                        <tr>
                          <td width="20" height="25" align="center" bgcolor="#FFFFFF" style=" font-size:14px;"><?=$objResult[0];?></td>
                          <td width="300" height="25" align="left" bgcolor="#FFFFFF" style=" font-size:14px;">&nbsp;&nbsp;<? if($objResult[5]==1){ ?><span style=" color:#FF0000;"><span class="w3-tag w3-red"style="background-color: red">หนังแนะนำ!</span></span> <? } ?><a href="../post-<?=$objResult[0];?>/<?=$posturl;?>.html" target="_blank"><?=$objResult[2];?></a></td>
                          <td width="200" height="25" align="center" bgcolor="#FFFFFF" style=" font-size:14px;"><a href="../cate-<?=$objResult[1];?>/<?=$urlcate;?>" target="_blank"><?=$rcate[0];?></a></td>
                          <td width="100" height="25" align="center" bgcolor="#FFFFFF" style=" font-size:14px;"><?=DateThai($objResult[3]);?></td>
                          <td width="60" height="25" align="center" bgcolor="#FFFFFF" style=" font-size:14px;"><?=$objResult[4];?></td>
                          <td width="50" height="25" align="center" bgcolor="#FFFFFF"><a href="edit-all-movie.php?id=<?=$objResult[0];?>"><img src="images/edit.gif" width="40" height="15" border="0" /></a></td>
