...
$id=$_GET['id'];
$smod="SELECT name FROM `member` WHERE id='$id' AND type=2";
$remod=mysqli_query($con_db, $smod) or die("ERROR $smod");
$rmod=mysqli_fetch_row($remod);
?>
    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" id="font-main" style="font-weight:bold; color:#333333;"><a href="mod.php">ผู้ช่วยแอดมิน</a> <img src="images/arrow.gif" width="7" height="11" /> รายการหนังของ <?=$rmod[0];?></td>
            </tr>
            <tr>
              <td align="center"><form action="del-mod-movie.php" method="post" name="frmMain" id="frmMain" onsubmit="return onDelete();">
                  ...
                  <tr>
                    <td align="center"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <table width="750" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                        <tr>
                          <td width="20" height="25" align="center" bgcolor="#E9E9E6" style=" font-size:16px; font-weight:bold;">#</td>
                          <td width="300" height="25" align="center" bgcolor="#E9E9E6" style=" font-size:16px; font-weight:bold;">ชื่อเรื่อง</td>
                          <td width="200" height="25" align="center" bgcolor="#E9E9E6" style=" font-size:16px; font-weight:bold;">หมวดหมู่</td>
                          <td width="100" height="25" align="center" bgcolor="#E9E9E6" style=" font-size:16px; font-weight:bold;">วันที่โพสต์</td>
                          <td width="60" height="25" align="center" bgcolor="#E9E9E6" style=" font-size:16px; font-weight:bold;">เข้าชม</td>
                          <td width="50" height="25" align="center" bgcolor="#E9E9E6" style=" font-size:16px; font-weight:bold;">แก้ไข</td>
...
$q="SELECT id, cate_id, title, post_date, view, sticky FROM `post` WHERE m_id='$id' ";
$q.=" ORDER BY id DESC ";
...
?>
                        <tr>
                          <td width="20" height="25" align="center" bgcolor="#FFFFFF" style=" font-size:16px;"><?=$objResult[0];?></td>
                          <td width="300" height="25" align="left" bgcolor="#FFFFFF" style=" font-size:16px;">&nbsp;&nbsp;<? if($objResult[5]==1){ ?><span style="font-weight:bold; color:#FF0000;">[ หนังแนะนำ ]</span> <? } ?><a href="../post-<?=$objResult[0];?>/<?=$posturl;?>.html" target="_blank"><?=$objResult[2];?></a></td>
                          <td width="200" height="25" align="center" bgcolor="#FFFFFF" style=" font-size:16px;"><a href="../cate-<?=$objResult[1];?>/<?=$urlcate;?>" target="_blank"><?=$rcate[0];?></a></td>
                          <td width="100" height="25" align="center" bgcolor="#FFFFFF" style=" font-size:16px;"><?=DateThai($objResult[3]);?></td>
                          <td width="60" height="25" align="center" bgcolor="#FFFFFF" style=" font-size:16px;"><?=$objResult[4];?></td>
                          <td width="50" height="25" align="center" bgcolor="#FFFFFF"><a href="edit-mod-movie.php?id=<?=$objResult[0];?>&mod_id=<?=$id?>"><img src="images/edit.gif" width="40" height="15" border="0" /></a></td>
                  ...
                  <tr>
                    <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
						...
						<input type="submit" name="Submit" id="Submit" value="ลบข้อมูล" />
						<input type="hidden" name="hdnCount" value="<?=$i;?>" />
						<input type="hidden" name="mod_id" id="mod_id" value="<?=$id;?>" />
						</td>
                      </tr>
                    </table></td>
                  </tr>
