...
$logo="select * from site_logo_share where id=1";
    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td><form id="form1" name="form1" method="post" action="p-site-logo-share.php" enctype="multipart/form-data">
                <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="center"><font size="3" color="#333333">Site Logo ควรมีขนาด 1200x800 px</font></td>
                  </tr>
                  <tr>
                    <td align="center"><img src="../logo-img/<?=$rlogo[1];?>" width="500" height="" /></td>
                  </tr>
                  <tr>
