...
$id=$_GET['id'];
$sp="SELECT name, email, pass FROM `member` WHERE type=1 AND id='$id'";
    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" id="font-main" style="font-weight:bold; color:#333333;"><a href="admin.php">จัดการข้อมูลแอดมิน</a> <img src="images/arrow.gif" width="7" height="11" /> แก้ไขข้อมูลแอดมิน</td>
            </tr>
            <tr>
              <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td><form action="p-edit-admin.php" method="post" enctype="multipart/form-data" name ="checkForm" id="checkForm" onsubmit="return check1()">
                    ...
                    <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="10">&nbsp;</td>
                          <td width="440">
						  <input name="name" type="text" id="name" value="<?=$rp[0];?>" />
                        ...
                        <tr>
                          ...
                          <td>&nbsp;</td>
                          <td width="440" id="font-main" style="color:#FF0000;"><input name="pass" type="password" id="pass" value="<?=$rp[2];?>" /> <?=$rp[2];?></td>
                        </tr>
...
?>
                        <tr>
                          ...
                          <td width="100" align="center" valign="middle"><a href="edit-admin.php?id=<?=$r[0];?>"><img src="images/edit.gif" width="40" height="15" border="0" /> </a><a href="del-admin.php?id=<?=$r[0];?>" onclick="javascript:if(!confirm('ท่านต้องการลบข้อมูลจริงหรือไม่')){return false;}"> <img src="images/del.gif" width="40" height="15" border="0" /></a></td>
                        </tr>
                        <? $x++;} ?>
                      </table></td>
                </tr>
