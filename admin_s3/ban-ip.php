    ...
    <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="left" style=" font-size:16px; font-weight:bold; color:#333333;"><a href="ban-ip.php">จัดการข้อมูลแบนไอพี</a> <img src="images/arrow.gif" width="7" height="11" /> เพิ่มข้อมูลแบนไอพี </td>
            </tr>
            <tr>
                    ...
                    <tr>
                      <td><form method="post" action="p-ban-ip.php" enctype="multipart/form-data" name ="checkForm" id="checkForm" onsubmit="return check1()">
                        <table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="right"><font size="3" color="#333333">เพิ่มเลข IP(ไอพี)</font></td>
                            <td width="10">&nbsp;</td>
...
return true ;
                ...
                <tr>
                  <td><table width="656" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#E9E9E6">
                    <tr>
                      <td width="250" height="30" align="center" valign="middle" bgcolor="#EFEFED"><font color="#333333" size="3">รายการ และ IP(ไอพี) ที่ถูกแบน</font></td>
                ...
                <tr>
                  <td><table width="100%" height="10" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <table width="630" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center"><font size="3" color="#000000">รายการข้อมูลแบนไอพี
                              <?=$total;?>
                              รายการ : แสดงผลหน้าละ
                              <?=$e_page;?>
                              รายการ จำนวนทั้งหมด
